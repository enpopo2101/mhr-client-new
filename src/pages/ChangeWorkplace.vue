<template>
  <div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div>
        <h5><b>Danh sách nhân viên điều chuyển công tác</b></h5>
      </div>
      ...
      <div class="container">
        <div class="row d-flex justify-content-between align-items-baseline">
          <p style="margin-left: 10px; font-size: 20px">
            <b>Thêm thông tin nhân viên điều chuyển công tác</b>
          </p>
        ...
        <div class="row container">
          <form class="form-horizontal col-md-12" @submit="submit">
            <div class="form-group row">
              <label for="title" class="col-md-3 col-form-label">Mã người dùng</label>
            ...
            ></user-picker>
            <div class="form-group row">
              <label for="title" class="col-md-3 col-form-label">Điểm chuyển đến</label>
              <div class="controls col-md-8">
                <input class="form-control" required v-model="body.title" />
              </div>
            </div>
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { name: "checkbox-slot", title: "", width: "2%" },
        { name: "action-slot", title: "Tác vụ", width: "20%" },
        { name: "Mã người dùng", title: "Mã người dùng", width: "18%" },
        ...
        { name: "title", title: "Điểm chuyển đến", width: "20%" },
        { name: "date", title: "Ngày ra quyết định", width: "25%" }
      ],
      body: {},
      data: [],
      user: null,
